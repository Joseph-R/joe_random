...
* Tech - Vanilla TI:4 guides leaned heavily into the Blue tech tree, which focuses on mobility.  Mobility is key to so much of the game that you will rarely go wrong choosing blue tech round one or two.  However the tech trees are more varied in PoK, and AI Dev opens up unit upgrade paths that had not previously been available.  
